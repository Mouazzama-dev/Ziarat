...
const Footer = () => (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
        <div className={`${styles.flexStart} lg:flex-row flex-col w-full grid lg:grid-cols-12 grid-cols-3 gap-3`}>
            <div className="flex  lg:flex-col flex-row justify-between lg:col-span-3 col-start-1 col-end-7">
                <img
                    src={logo}
                    alt="Ziarat Logo"
